  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        <div
          aria-hidden
          className="absolute mt-16 inset-0 isolate hidden opacity-65 contain-strict lg:block"
        >
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Introducing the best Learning Model
                    </span>
                ...
                >
                  Modern Solutions for Educative Engagement
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                ...
                >
                  Our platform provides a comprehensive suite of tools designed
                  to enhance the learning experience for both educators and
                  students.
                </TextEffect>
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <Image
                    className="bg-background aspect-16/12 relative rounded-2xl block"
                    src="/dashboard.png"
                    alt="app screen"
                    width="2700"
                    height="1240"
